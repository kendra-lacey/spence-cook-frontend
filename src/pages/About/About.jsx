        ...
        <div id="music-div" className="gear-text">
          ...
          {isMoreTop ? 
            ...
            <div className="expanded" id="expanded-music">
              ...
              <a href="/album">
                <img id='listen-btn' src="./listenBtn.png" alt="" />
              </a>
            </div>
            </>) 
            : 
            ...
            <div className="expandable" id="expandable-music">
              <p>My main drive now, my primary inspiration and guiding force, can be best described as a sense of nearing midlife, although that term might be a bit strong. Reaching this stage.... 
